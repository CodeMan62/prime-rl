# coding=utf-8
# Copyright 2025 OpenAI and the HuggingFace Inc. team. All rights reserved.
#
...
class GptOssDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: GptOssConfig, layer_idx: int):
        ...
        # Use MoE for layers not in mlp_only_layers
        if layer_idx not in config.mlp_only_layers and config.num_local_experts > 0:
